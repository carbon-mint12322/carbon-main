...
const LandParcelProcessingUnitEditor = dynamic(
  import('~/gen/data-views/landparcel_processingunits/landparcel_processingunitsEditor.rtml'),
);
  ...
  return (
    <>
      <Dialog open={Boolean(openModal)} onClose={toggleOpenModal} fullWidth maxWidth={'md'}>
        <LandParcelProcessingUnitEditor
