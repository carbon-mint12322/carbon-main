...
import { BioItem } from './FarmerDetailsBioCardContent';

interface FarmerDetailsBioCardProps {
  title?: string;
...
export default FarmerDetailsBioCard;
