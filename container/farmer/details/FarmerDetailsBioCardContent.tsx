...
import FarmerDetailsBioCard from './FarmerDetailsBioCard';
...
export interface FarmerDetailsBioCardContentProps {
  data?: BioItem[];
  title?: string;
  url?: string;
  onButtonClick?: () => void;
...
const FarmerDetailsBioCardContent = ({
  data,
  title,
  onButtonClick = () => null,
}: FarmerDetailsBioCardContentProps) => {
  return (
    <FarmerDetailsBioCard
      title={title}
      BioChipComponent={
...
export default FarmerDetailsBioCardContent;
