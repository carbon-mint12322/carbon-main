...
const updateProcessingSystemEvent = async (ctx: WorkflowContext) => {
  ...
  console.debug('Processing system event update completed', { results });
  return;
};

export default updateProcessingSystemEvent;
