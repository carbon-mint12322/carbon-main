...
import { processorDetailsMobileQuery } from '~/backendlib/db/dbviews/processor/processorDetailsMobileQuery';

const schemaId = '/farmbook/farmer';
const modelApi = getModel(schemaId);
export const permittedRoles = ['PROCESSOR', 'AGENT'];
...
const handler = async (req: NextApiRequest, res: NextApiResponse): Promise<any> => {
  ...
  const result = await processorDetailsMobileQuery(id);
