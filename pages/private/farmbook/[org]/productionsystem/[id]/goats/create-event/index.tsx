...
const workflowNames = [
  ['goatFeedPSLifecycle', 'goatMedicationPSLifecycle', 'goatVaccinationPSLifecycle'],
  ['goatMilkingPSLifecycle'],
  ['goatSalePSLifecycle'],
];
...
function Content(props: any) {
  ...
  async function goatsFilter() {
    const res: {
      data: any;
    } = await axios.get(getAPIPrefix() + `/goat`);

    // Filter the data array based on the productionSystemId
    const filteredData = res.data.filter(
      (goat: any) => goat.productionSystem === productionSystemId,
    );
  ...
  const formContext: any = {
    getApiUrl,
    foreignObjectLoader:
      wfName === 'goatFeedPSLifecycle' ||
        wfName === 'goatMedicationPSLifecycle' ||
        wfName === 'goatVaccinationPSLifecycle' ||
        wfName === 'goatMilkingPSLifecycle' ||
        wfName === 'goatSalePSLifecycle'
        ? goatsFilter
        : undefined,
  };
