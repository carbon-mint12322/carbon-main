...
// export { default } from '~/gen/pages/createprocessor/ui';
// Generated code (tools/templates/pages/model-page-endpoint.tsx.mustache)
...
import { ProcessorFormData, PageConfig } from '~/frontendlib/dataModel';
...
interface CreateProcessorProps {
  sx: SxProps;
  pageConfig: PageConfig;
  data: any;
}

function CreateProcessor(props: CreateProcessorProps) {
  ...
  function createProcessor(input: any) {
    return mutate({
      ...input,
      eventData: { ...input.eventData, type: 'Processor' },
...
export default withAuth(CreateProcessor);
